...
onWorkflow ->
  ...
  window.step_types = [Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Datetime, Register, Deregister, Language, MarkAsFailed, MarkAsSuccessful].concat(External.classes())
