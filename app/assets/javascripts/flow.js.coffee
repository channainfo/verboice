...
onWorkflow ->
  ...
  window.step_types = [Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Register, Deregister, Language, MarkAsFailed, MarkAsSuccessful].concat(External.classes())
