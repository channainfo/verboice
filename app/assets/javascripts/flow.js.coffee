...
onWorkflow ->
  ...
  window.step_types = [Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Language, MarkAsFailed, MarkAsSuccessful, HangUpAndCallBack, Nuntium, Datetime, Register, Deregister].concat(External.classes())
