module Ext
 ...
 class Util
 	...
 	def self.parse_date_time str, time_zone="UTC", format = Util::DEFAULT_DATE_FORMAT 
	...
	def self.date_time_to_str date_time, time_zone = "UTC", format = Util::DEFAULT_DATE_FORMAT 
