...
namespace :foreman do
  ...
  task :export, :roles => :app do
    ...
    run "cd #{current_path} && rvmsudo bundle exec foreman export upstart /etc/init -f #{current_path}/Procfile -a #{application} -u #{user} --concurrency=\"asterisk_adapter=1,delayed=1\""
  end
